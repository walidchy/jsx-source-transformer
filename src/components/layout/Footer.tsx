        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              La solution de facturation et gestion commerciale 100% conforme à la réglementation marocaine.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-400">contact@efacture-maroc.com</li>
              <li className="text-gray-400">+212 522 123 456</li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} efacturemaroc.com. Tous droits réservés.
            </p>
