...
const ClientInvoices = () => {
  ...
  const invoices = [
    { id: 'FAC-2023-042', amount: '12 500,00 MAD', date: '15/04/2023', dueDate: '15/05/2023', status: 'paid' },
    { id: 'FAC-2023-041', amount: '8 340,00 MAD', date: '12/04/2023', dueDate: '12/05/2023', status: 'pending' },
    { id: 'FAC-2023-040', amount: '4 200,00 MAD', date: '10/04/2023', dueDate: '10/05/2023', status: 'overdue' },
    { id: 'FAC-2023-039', amount: '15 750,00 MAD', date: '05/04/2023', dueDate: '05/05/2023', status: 'paid' },
    { id: 'FAC-2023-038', amount: '6 820,00 MAD', date: '01/04/2023', dueDate: '01/05/2023', status: 'paid' },
    { id: 'FAC-2023-037', amount: '9 300,00 MAD', date: '28/03/2023', dueDate: '28/04/2023', status: 'paid' },
  ];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 flex items-center justify-between p-4">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-semibold text-gray-800">Mes Factures</h1>
          </div>
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50 p-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Liste complète de vos factures</CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <td className="px-4 py-3 text-sm text-right">
                          <div className="flex justify-end gap-2">
                            <Button variant="outline" size="sm" asChild>
                              <Link to={`/client/invoices/${invoice.id}`}>Voir</Link>
                            </Button>
                            <Button variant="outline" size="sm" asChild>
                              <Link to={`/client/invoices/${invoice.id}/edit`}>Modifier</Link>
                            </Button>
                          </div>
                        </td>
                      </tr>
